...
class StatesControllerTest < ActionController::TestCase
  ...
  test "should create state" do
    assert_difference('State.count') do
      post :create, state: { accepts: @state.accepts, machine_id: @state.machine_id, name: @state.name, starts: @state.starts }
    end
  ...
  test "should update state" do
    patch :update, id: @state, state: { accepts: @state.accepts, machine_id: @state.machine_id, name: @state.name, starts: @state.starts }
    assert_redirected_to state_path(assigns(:state))
  end
